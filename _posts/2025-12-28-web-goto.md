...
//    public ResponseEntity<Map<String, Object>> getCompanyInfo() throws Exception {
//        Map<String,Object> params = new HashMap<>();
//        int com_seq = Integer.parseInt(Utils.getCompanyData("com_seq"));
//        if (com_seq == 10) {
//            //자바 바로가기 기능 테스트
//            try {
//                //서버
////                String serverIconUrl = "https://www.spielraum.or.kr/common/testmain/img/spielraum.ico";
//                //로컬
//                String serverIconUrl = "http://localhost:8080/common/testmain/img/spielraum.ico";
//                String localIconPath = System.getProperty("user.home") + "\\efuture.ico";
//                logger.info("localIconPath = " + localIconPath);
//                // 아이콘 파일 다운로드
//                downloadFileFromServer(serverIconUrl, localIconPath);
//
...
//                        "Set oWS = WScript.CreateObject(\"WScript.Shell\")\n" +
//                                "sDesktop = oWS.SpecialFolders(\"Desktop\")\n" +
//                                "sLinkFile = sDesktop & \"\\슈필라움.lnk\"\n" +
//                                "Set oLink = oWS.CreateShortcut(sLinkFile)\n" +
//                                "oLink.TargetPath = \"https://www.spielraum.or.kr/incheon\"\n" +
//                                "oLink.WorkingDirectory = \"C:\\\\Program Files\\\\Example\"\n" +
//                                "oLink.WindowStyle = 1\n" +
//                                "oLink.Description = \"슈필라움 바로가기\"\n" +
//                                "oLink.IconLocation = \"" + localIconPath + "\"\n"  +
//                                "oLink.Save";
//
//                // VBScript 파일 생성
...
////        try {
////            int com_seq = Integer.parseInt(Utils.getCompanyData("com_seq"));
////            params.put("com_seq", com_seq);
////
////            ObjectMapper mapper = new ObjectMapper();
////            Map<String,Object> jsonObject = mapper.convertValue(params, Map.class);
